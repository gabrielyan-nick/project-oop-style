...
window.addEventListener("DOMContentLoaded", function () {
  ...
  mainSlider.render();
  var mainSliderModule = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    next: ".nextmodule",
    prev: ".prevmodule",
    container: ".moduleapp",
...
function () {
  ...
  _createClass(Form, [{
    ...
    key: "noCyrillicInput",
    value: function noCyrillicInput(inputtype) {
      var inputs = document.querySelectorAll("[name=".concat(inputtype, "]"));
    ...
    key: "modalMessage",
    value: function modalMessage(mes) {
...
function (_Slider) {
  ...
  function MiniSlider(container, btns, prev, next, activeClass, animate, autoplay) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, btns, prev, next, activeClass, animate, autoplay));
  }
    ...
    value: function init() {
      ...
      try {
        ...
        this.container.addEventListener("mouseleave", function () {
          _this4.autoPlaySlide();
        });
        this.btns.forEach(function (btn) {
          btn.addEventListener("mouseleave", function () {
            return _this4.autoPlaySlide();
          });
        });
      } catch (e) {}
    }
